...
public class CropOverlayView extends View {
    ...
    /**
     * Informs the CropOverlayView of the image's position relative to the ImageView. This is necessary to call in order
     * to draw the crop window.
    ...
    /**
     * Sets all initial values, but does not call initCropWindow to reset the views. Used once at the very start to
    ...
    private void init(Context context) {
        ...
        mCornerOffset = TypedValue
                .applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_CORNER_OFFSET_DP, displayMetrics);
        mCornerExtension = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_CORNER_EXTENSION_DP,
                displayMetrics);
        mCornerLength = TypedValue
                .applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_CORNER_LENGTH_DP, displayMetrics);
    ...
    /**
     * Set the initial crop window size and position. This is dependent on the size and position of the image being
     * cropped.
    ...
    private void initCropWindow(Rect bitmapRect) {
        ...
        if (mFixAspectRatio) {
            ...
            if (AspectRatioUtil.calculateAspectRatio(bitmapRect) > mTargetAspectRatio) {
                ...
                final float cropWidth = Math.max(Edge.MIN_CROP_LENGTH_PX, AspectRatioUtil.calculateWidth(
            ...
            // Initialize crop window to have 10% padding w/ respect to .
    ...
    /**
     * Indicates whether the crop window is small enough that the guidelines should be shown. Public because this
     * function is also used to determine if the center handle should be focused.
     ...
     */
    private void onActionDown1(float x, float y) {
     ...
     * @param y the y-coordinate of the move event
     */
    private void onActionMove1(float x, float y) {
    ...
    public void setOutlineTouchEventReceiver(ImageView mImageView) {
    ...
    public void setImageView(ImageView mImageView2) {
        this.mImageView = mImageView2;
        invalidate();
    }
